...
public class CloseIssueCommandTest {
    ...
    public void execute_closeIssue_success() throws Exception {
         ...
         */
        assertEquals (String.format(CloseIssueCommand.MESSAGE_SUCCESS, INDEX_ISSUE.getOneBased()), commandResult.feedbackToUser);
    }
    ...
    public void execute_authenticationError_throwsCommandException() throws Exception {
        ...
        thrown.expectMessage("Github not authenticated. Use 'gitlogin' command to first authenticate your github account" );
