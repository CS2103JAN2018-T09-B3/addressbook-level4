...
After forking the repo, links in the documentation will still point to the `se-edu/progresschecker-level4` repo. If you plan to develop this as a separate product (i.e. instead of contributing to the `se-edu/progresschecker-level4`) , you should replace the URL in the variable `repoURL` in `DeveloperGuide.adoc` and `UserGuide.adoc` with the URL of your fork.
...
**Additional Info:** See our discussion  https://github.com/se-edu/progresschecker-level4/issues/390#issuecomment-298936672[here].
...
** See this https://github.com/se-edu/progresschecker-level4/pull/785[PR] for the full solution.
****
...
** See this https://github.com/se-edu/progresschecker-level4/pull/790[PR] for the full solution.
*** The current codebase has a flaw in tags management. Tags no longer in use by anyone may still exist on the link:{repoURL}/src/main/java/seedu/address/model/ProgressChecker.java[`ProgressChecker`]. This may cause some tests to fail. See issue  https://github.com/se-edu/progresschecker-level4/issues/753[`#753`] for more information about this flaw.
...
** See this https://github.com/se-edu/progresschecker-level4/pull/798[PR] for the full solution.
...
** See this https://github.com/se-edu/progresschecker-level4/pull/799[PR] for the full solution.
...
** See this https://github.com/se-edu/progresschecker-level4/pull/803[PR] for the full solution.
****
...
* Solution
** See this https://github.com/se-edu/progresschecker-level4/pull/594[PR] for the full solution.
****
...
See this https://github.com/se-edu/progresschecker-level4/pull/599[PR] for the step-by-step solution.
