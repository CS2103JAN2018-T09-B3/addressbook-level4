...
+
Now, you are ready to start exploring ProgressChecker!
...
You should see the feedback that a verification code has been received. +
Type **`view task`** then **`viewtasklist *`** +
...
You should now see your newly created issue reflected under the Issues tab.
