...
[TIP]
If you accidentally overwrite your answer to an exercise, you can undo the change as this is an undoable command! Check out the <<Undoing previous command,undo>> and <<Redoing the previously undone command,redo>> commands on how you can achieve this.
