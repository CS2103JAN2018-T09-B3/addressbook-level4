...
** *What it does:* allows the student to quickly view exercises by week and save their answers down for it. Answers are stored automatically and loaded the next time the software runs again.
** *Justification:* this feature solves a significant issue that students faced when using the module website: they can't find the exercises easily, or save their answers down directly for that matter as a means for ease of future reference.
